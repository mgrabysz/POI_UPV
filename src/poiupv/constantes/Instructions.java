...
public class Instructions {
    public static String SELECTION_INSTR = "Haz clic a una marca para obtener su color. Mueve la mapa con el ratón";
    public static String MARK_POINT_INSTR = "Haz clic a la mapa para marcar el punto en color seleccionado";
    public static String DRAW_LINE_INSTR = "Selecciona el color y el grosor. Arrastra el ratón con el botón pulsado para marcar la línea";
